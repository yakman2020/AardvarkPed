...
/*
if (i == 0) {
System.err.println("series = "+series.getTitle());
}
 */
...
/*
if (i == 0) {
System.err.println("startIndex = "+startIndex+"yValue = "+yValue+"xValue = "+xValue);
}
*/
...
if (i == 0) {
    ...
    System.err.println("points.size = "+points.size()+" startIndex = "+startIndex+" yValue = "+yValue+" xValue = "+xValue);
    if (points.size() < 4) {
        System.err.println("not a bar");
    }
}
*/
