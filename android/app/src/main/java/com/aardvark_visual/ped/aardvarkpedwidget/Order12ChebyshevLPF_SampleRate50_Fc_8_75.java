...
public class Order12ChebyshevLPF_SampleRate50_Fc_8_75 extends FilterCoefficients {

    public String name() { return "6 pole Chebyshev band pass filter. Sample rate = 50 samples per second. Bandpass 0.9-4.5 hz"; };
