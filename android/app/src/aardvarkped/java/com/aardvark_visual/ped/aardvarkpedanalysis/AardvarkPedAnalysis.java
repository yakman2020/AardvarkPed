...
public class AardvarkPedAnalysis extends Activity implements ActionBar.OnNavigationListener {
    ...
    public  final static String AppContextName = "com.aardvark_visual.ped";
    public  final static String AppSharedPreferencesName = "com.aardvark_visual.ped_preferences";
