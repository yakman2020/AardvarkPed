...
public class AardvarkPedAnalysis extends Activity implements ActionBar.OnNavigationListener {
    ...
    public  final static String AppContextName = "com.aardvark_visual.ped.aardvarkpedplus";
    public  final static String AppSharedPreferencesName = "com.aardvark_visual.ped.aardvarkpedplus_preferences";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File app_file_root = this.getExternalFilesDir(null);
        File file_dir      = null;
        boolean made_dirs  = false;
        if (file_dir == null) {
            try {
                file_dir = new File(app_file_root+"/Documents/com.aardvark_visual.ped.aardvarkped/logs");
            }
            catch(Exception e) {

                // Not present before KitKat.
                String dir_name = app_file_root.toString();
        ...
        if (stepdb_dir == null) {
            try {
                stepdb_dir = new File(app_file_root+"/Documents/com.aardvark_visual.ped.aardvarkped/db");
            }
            catch(Exception e) {
        ...
        try {
             ...
             mSharedPreferences = prefsContext.getSharedPreferences(AppSharedPreferencesName, Context.MODE_MULTI_PROCESS);
         }
         catch(Exception e) {
             mSharedPreferences = getSharedPreferences(AppSharedPreferencesName, Context.MODE_PRIVATE); // This is just to prevent segvs
         }
    }
    ...
    public void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        // Restart the count. TBD: keep a paused element in the state in case someone has turned off the 
        // counter
    ...
    private static AlertDialog mBluetoothProgressDialog = null;
    private static AlertDialog.Builder mBluetoothProgressDialogBuilder = null;

    private static AlertDialog mBluetoothConfirmDialog = null;
    private static AlertDialog.Builder mBluetoothConfirmDialogBuilder = null;
    ...
    public static void ShowBluetoothProgress(final String progressName, final String progress, final boolean finished ) {
            if (AardvarkPedAnalysis.mActivity != null) {
                AardvarkPedAnalysis.mActivity.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        AardvarkPedAnalysis.BluetoothProgressBar(AardvarkPedAnalysis.mActivity, progressName, progress, finished);
                    }
                });
            }
    ...
    public static boolean BluetoothProgressBar(Context context, final String progressName, final String  progress, final boolean finished) {
        if (mBluetoothProgressDialogBuilder == null) {
              tv = new TextView(context);
              tv.setText(progress);

              mBluetoothProgressDialogBuilder = new AlertDialog.Builder(context);
              mBluetoothProgressDialogBuilder.setIcon(R.drawable.aardvark_ped_icon_small);
              mBluetoothProgressDialogBuilder.setTitle(progressName);
              mBluetoothProgressDialogBuilder.setView(tv);
               

              mBluetoothProgressDialog =  mBluetoothProgressDialogBuilder.show();
              mBluetoothProgressDialog.setCanceledOnTouchOutside(false) ;
              final ActionBar action_bar = AardvarkPedAnalysis.mActivity.getActionBar();
              action_bar.hide();
              return true;
        }

        mBluetoothProgressDialog.setTitle(progressName);
        tv.setText(progress);
        ...
        if (finished) {
            ...
            mBluetoothProgressDialog        = null;
            mBluetoothProgressDialogBuilder = null;
            tv = null;
        }
    ...
    public boolean onNavigationItemSelected(int position, long id) {
        ...
        switch(position) {
            case 0:
                frag =  StepsPerDayChartFragment.newInstance(this, 1);
                break;

            case 1:
                frag = StepsPerWeekFragment.newInstance(this, 2);
                break;

            case 2:
                frag = DistancePerDayChartFragment.newInstance(this, 3);
                break;

            case 3:
                frag = DistancePerWeekChartFragment.newInstance(this, 4);
                break;

            case 4:
                frag = CadenceChartFragment.newInstance(this, 5);
                break;

            case 5:
                frag = (Fragment)SettingsFragment.newInstance(this, 6);
                break;
    ...
    public void onOptionsMenuClosed(Menu menu) {
        ...
        if ( mBluetoothConfirmDialog != null ) {
            mBluetoothConfirmDialog.dismiss();
            mBluetoothConfirmDialog = null;
        }
    ...
    public void onDestroy() {
        ...
        mBluetoothProgressDialogBuilder = null;
        mBluetoothConfirmDialogBuilder = null;
        mProgressDialogBuilder = null;
    ...
    public static class StepsPerDayChartFragment extends Fragment {
        ...
        private static boolean mShowHeart           = false;
        ...
        private GraphicalView BuildChartStepsByHour(Context context) {
                ...
                RangeCategorySeries hr_max_series = new RangeCategorySeries("HeartRateMax");
                XYMultipleSeriesDataset  dataset = new XYMultipleSeriesDataset();
                XYSeries             step_series = null;

                // XYSeries hr_min_series = new XYSeries("HeartRateMin", 2);
                //XYSeries hr_avg_series = new XYSeries("HeartRateAvg", 3);
                ...
                ArrayList<Integer> hr_min = new ArrayList<Integer>();
                ArrayList<Integer> hr_max = new ArrayList<Integer>();
                ArrayList<Integer> hr_avg = new ArrayList<Integer>();

                int[] steps_per_hour = AardvarkPedAnalysis.mAardvarkPedAnalyzeStepsByMinute.StepsForDay(daystartinmillis, num_days, hr_min, hr_max, hr_avg);

                int max_heart_rate = 0;
                for (int i = 1; i < hr_max.size(); i++ ) {
                    if (hr_max.get(i) > max_heart_rate) {
                        max_heart_rate = hr_max.get(i);
                    }
                }

                if (max_heart_rate > 0) {
                    for (int i = 1; i < hr_min.size(); i++ ) {
                        double min_hr = ((double)hr_avg.get(i));
                        double max_hr = ((double)hr_max.get(i)); 
                         int idx = (i*2)+1;

                         if (max_hr > 0.0) {
                             hr_max_series.add(min_hr, max_hr);
                         }
                         else {
                             hr_max_series.add(MathHelper.NULL_VALUE, MathHelper.NULL_VALUE);
                         }
                    }

                    mHasHeartData = true;
                    dataset.addSeries(hr_max_series.toXYSeries());
                    mRenderer   = new XYMultipleSeriesRenderer(2);
                    step_series = new XYSeries("StepsPerDay",  1);
                    dataset.addSeries(1, step_series);
                ...
                XYSeriesRenderer hr_renderer = null;
                if (mHasHeartData) {
                    hr_renderer = new XYSeriesRenderer();
                    hr_renderer.setColor(Color.parseColor("#ff2211"));
                    hr_renderer.setDisplayChartValues(true);
                    hr_renderer.setChartValuesTextAlign(Paint.Align.RIGHT);
                    hr_renderer.setChartValuesTextSize(11.0f* getResources().getDisplayMetrics().density);
                    hr_renderer.setChartValuesSpacing(6.0f* getResources().getDisplayMetrics().density);
                    hr_renderer.setDisplayChartValuesDistance((int)(6.0f* getResources().getDisplayMetrics().density));
                    hr_renderer.setShowLegendItem(false);
                    hr_renderer.setLineWidth(1.0f);
                    hr_renderer.setFillPoints(true);
                    hr_renderer.setPointStyle(PointStyle.DIAMOND);
                    hr_renderer.setPointStrokeWidth(5.0f);
                    mRenderer.setBarWidth(2.0f);

                    mRenderer.addSeriesRenderer(hr_renderer);
                    mRenderer.setYAxisMin(0.0, 0);
                    mRenderer.setYAxisMax(210.0, 0);
                    mRenderer.setYLabelsAlign(Paint.Align.LEFT, 0);
                    mRenderer.setYLabelsColor(0, Color.parseColor("#ff2211"));
                    mRenderer.setYTitle("", 0);
                    double label_val = 0.0;
                    for (int i = 0; i < 7; i++) {
                        mRenderer.addYTextLabel(label_val, Integer.toString((int)label_val), 0);
                        label_val += 210.0/7.0;
                    }
                    mRenderer.addYTextLabel(210, "    bps", 0);
                }    

                XYSeriesRenderer step_renderer = new XYSeriesRenderer();
                step_renderer.setChartValuesFormat(new DecimalFormat("####"));
                ...
                if (!mHasHeartData) {
                    ...
                    mRenderer.setBarWidth(5.0f);
                    mRenderer.setYAxisMin(0, 1);
                    mRenderer.setYAxisMax(display_range, 1);
                    mRenderer.setYLabelsAlign(Paint.Align.RIGHT, 1);
                    mRenderer.setYLabelsColor(1, Color.parseColor("#11AAff"));
                    double label_val = 0.0;
                    for (int i = 0; i < (int)num_ticks; i++) {
                        mRenderer.addYTextLabel(label_val, String.format("%4d\t\t", (int)label_val), 1);
                        label_val += tick_size;
                    }

                    if (!mShowHeart) {
                        hr_renderer.setColor(Color.TRANSPARENT);
                        step_renderer.setColor(Color.parseColor("#FF11AAff"));
                        step_renderer.setDisplayChartValues(true);
                    }
                    else {
                        hr_renderer.setColor(Color.parseColor("#ff2211"));
                        step_renderer.setColor(Color.parseColor("#4411AAff"));
                        step_renderer.setDisplayChartValues(false);
                    }
                    ...
                    CombinedXYChart.XYCombinedChartDef[] chart_types =
                         new CombinedXYChart.XYCombinedChartDef[]{ 
                                                                   ...
                                                                   new CombinedXYChart.XYCombinedChartDef(RangeBarChart.TYPE, 0) };
                    GraphicalView  rslt = null;
                    try {
                        rslt = ChartFactory.getCombinedXYChartView(context, dataset, mRenderer, (CombinedXYChart.XYCombinedChartDef[]) chart_types);
                    }
                    catch(Exception e) {
                        e.printStackTrace();
                    }
       ...
       public static StepsPerDayChartFragment newInstance(AardvarkPedAnalysis activity, int sectionNumber) {
        ...
        private static View.OnTouchListener mHideHeartRateTouchAction = new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent ev) {
                ...
                if (StepsPerDayChartFragment.mRenderer == null) {
                    return false;
                }
                int num_renderers = StepsPerDayChartFragment.mRenderer.getSeriesRendererCount();
                if (num_renderers < 2) {
                    return false;  // There is no heart rate info.
                }

                // If there is heart rate info, the range chart is renderer 0 and the bar chart is renderer(1).
                // If no heart rate info, there is only renderer 0 as the bar chart 

                XYSeriesRenderer hr_renderer   = (XYSeriesRenderer)StepsPerDayChartFragment.mRenderer.getSeriesRendererAt(0);
                XYSeriesRenderer step_renderer = (XYSeriesRenderer)StepsPerDayChartFragment.mRenderer.getSeriesRendererAt(1);
        ...
        public void onResume() {
            ...
            // We set the visibility to "GONE" when we paused. 
            // When we resume we need to make it visible again
    ...
    public static class SettingsFragment extends PreferenceFragment {
      ...
      //  private static final String PREFKEY_Archive_BOOLEAN          = "com.aardvark_visual.ped.archive_boolean";
        ...
        private static AardvarkPedAnalysis mActivity = null;
        private static AardvarkPedAnalysis.SettingsFragment mFrag = null;
        // private static PreferenceManager mPreferenceManager = null;
        // private static SharedPreferences mSharedPreferences = null;
        ...
        private static CheckBoxPreference mHeartRateDevScan = null;
             ...
             if (AardvarkPedAnalysis.mActivity != null) {
                AardvarkPedAnalysis.mActivity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        String summary = null;
                        if (heart_dev != null) {
                            String heart_dev_name = AardvarkPedBluetooth.getSelectedHeartRateDeviceName();
                            if (heart_dev_name == null) {
                                heart_dev_name = "not selected";
                            }
                            if (AardvarkPedBluetooth.getHeartRateDeviceConnected()) {
                                summary = "selected device "+heart_dev_name+" connected" ;
                                if (mHeartRatePref != null) {
                                    mHeartRatePref.setSummary(summary);
                                }
                            }
                            else {
                                summary = "selected device "+heart_dev_name+" not connected" ;
                                if (mHeartRatePref != null ) {
                                    mHeartRatePref.setSummary(summary);
                                }
                            }
        ...
        private void EnableHeartRateSelectionPreference(String [] device_names, String[] device_values) {
                ...
                mHeartRatePref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                    ...
                    public boolean onPreferenceChange(Preference preference, Object newValue) {
                        ...
                        AardvarkPedAnalysis.mSharedPreferences.edit().putString("PREFKEY_HeartRateDevice_STRING", val).commit();
                        AardvarkPedAnalysis.mSharedPreferences.edit().putString("PREFKEY_HeartRateDeviceName_STRING", name).commit();
                        ...
                        AardvarkPedBluetooth.setDeviceReconnectCallback(new AardvarkPedBluetooth.DeviceReconnectCallback() {
                             ...
                             public void onDeviceReconnectComplete(final boolean success, final BluetoothDevice dev, final Object data) {
                                     ...
                                     mHeartRatePref.setEnabled(false);
                                 };
                        },  null
                        );
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            mPrefStepCounter   = findPreference(AardvarkPedWidgetService.PREFKEY_UseNativeCounter);
            mStrideLength      = findPreference(AardvarkPedWidgetService.PREFKEY_StrideLength);
            mPurgeTimePref     = findPreference(AardvarkPedWidgetService.PREFKEY_ClearAfter);
            mPurgeArchivePref  = findPreference(AardvarkPedWidgetService.PREFKEY_Archive);
            mMeasurementSystem = findPreference(AardvarkPedWidgetService.PREFKEY_MeasurementSystem);
                mHeartRatePref = findPreference(AardvarkPedWidgetService.PREFKEY_SelectedHeartRate);
            mHeartRateDevScan  = (CheckBoxPreference)findPreference(AardvarkPedWidgetService.PREFKEY_ScanHeartRate);
            mHeartRateDeviceId = mSharedPreferences.getString(AardvarkPedWidgetService.PREFKEY_HeartRate_STRING, null);
            ...
            if (mHeartRateDevScan != null) {

                // Set the summary back to normal after possibly being modified by a scan.

                mHeartRateDevScan.setSummary(R.string.pref_scan_heart_rate_summary);
            }

            if (!AardvarkPedBluetooth.isEnabled()) {
               // mHeartRateDevScan.setVisible(false);
                mHeartRateDevScan.setEnabled(false);
            }
            else {
                AardvarkPedBluetooth.setDeviceDiscoveryCallback(new AardvarkPedBluetooth.DeviceDiscoveryCallback() { 
                         @Override
                         public void onDeviceDiscoveryComplete(Object data) {
                                 System.err.println("Discovery complete callback");
                                 if (AardvarkPedBluetooth.getSelectedHeartRateDevice() != null) {
                                     while(!AardvarkPedBluetooth.getHeartRateDeviceConnected()) {
                                         // Wait for the reconnect thread, still in progress
                                         try {
                                             Thread.sleep(2000); // Wait 2 seconds at a time.  The reconnect thread must be pretty close to done.
                                         }
                                         catch(Exception e) {
                                 ...
                                 mActivity.runOnUiThread(new Runnable() {
                                     public void run() {
                                          // UI code goes here
                                         String[] avail_device_names = AardvarkPedBluetooth.AvailableHeartRateDeviceNames();
                                         String[] avail_device_ids = AardvarkPedBluetooth.AvailableHeartRateDeviceIdentifiers();
                                         int num_dev = 0;
                                         if (avail_device_names != null) {
                                             num_dev = avail_device_names.length;
                                         }
                                         String msg = null;
                                         if (num_dev == 1) {
                                              msg = "Scan Complete. Found "+Integer.toString(num_dev)+" device";
                                         }
                                         else {
                                              msg = "Scan Complete. Found "+Integer.toString(num_dev)+" devices";
                                         }

                                         // We have to concatenate then split the dev name and id since
                                         // Sets don't guarantee order, and eliminate dups. We would never be able
                                         // to reliably associate the contents of two sets
                                         HashSet<String> device_set = new HashSet<String>();
                                         for (int i = 0; i < avail_device_names.length; i++) {
                                              if (!avail_device_ids[i].equals("")) {
                                                  device_set.add(avail_device_names[i] + "|" + avail_device_ids[i]);
                                              }
                                         }

                                         AardvarkPedAnalysis.mSharedPreferences.edit().putStringSet("PREFKEY_AvailableHeartRateDevices_STRINGSET", device_set).commit();
                                         mHeartRatePref.setEnabled(true);
                                         mHeartRateDevScan.setEnabled(true);
                                         mHeartRateDevScan.setSummary(msg);
                                         if (num_dev > 0 ) {
                                             EnableHeartRateSelectionPreference(avail_device_names, avail_device_ids);
                                         }
                                     }
                                 });
                             };
                ...
                mHeartRateDevScan.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                    @Override
                    public boolean onPreferenceChange(Preference preference, Object newValue) {
                        boolean val = (Boolean) newValue;

                        if (mBluetoothConfirmDialogBuilder == null) {
                              TextView tv = new TextView(mActivity);
                              String confirm_text = getResources().getString(R.string.scan_confirm_text);
                              String[] devnames = AardvarkPedBluetooth.AvailableHeartRateDeviceNames();
                              ...
                              tv.setText(confirm_text);
                
                              mBluetoothConfirmDialogBuilder = new AlertDialog.Builder(mActivity);
                              mBluetoothConfirmDialogBuilder.setIcon(R.drawable.aardvark_ped_icon_small);
                              mBluetoothConfirmDialogBuilder.setTitle(R.string.scan_confirm);
                              mBluetoothConfirmDialogBuilder.setView(tv);
                              mBluetoothConfirmDialogBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                   public void onClick(DialogInterface dialog, int which) {
                                               System.err.println("Scan for Bluetooth Devices");
                                               AardvarkPedBluetooth.DiscoverDevices(10000);
                                               mHeartRateDevScan.setSummary("Searching....");
                                               mBluetoothConfirmDialog.dismiss();
                                               mBluetoothConfirmDialogBuilder = null;
                                               mBluetoothConfirmDialog = null;
                                               mHeartRateDevScan.setEnabled(false);
                              ...
                              mBluetoothConfirmDialogBuilder.setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
                                   public void onClick(DialogInterface dialog, int which) {
                                               System.err.println("cancel");
                              ...
                              mBluetoothConfirmDialog =  mBluetoothConfirmDialogBuilder.show();
                              mBluetoothConfirmDialog.setCanceledOnTouchOutside(false) ;
                              mBluetoothConfirmDialog.show();
                        }
                        return true;
                    }
                });
                ...
                String[] device_names  = AardvarkPedBluetooth.AvailableHeartRateDeviceNames();
                if (device_names.length > 0 ) {
                   String[] device_values = AardvarkPedBluetooth.AvailableHeartRateDeviceIdentifiers();
                   BluetoothDevice heart_dev = AardvarkPedBluetooth.getSelectedHeartRateDevice();
            ...
            if (step_counter == null) {
                ...
                SharedPreferences.Editor editor = AardvarkPedAnalysis.mSharedPreferences.edit();
            ...
            if (metric != null) {
                metric.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                    ...
                    public boolean onPreferenceChange(Preference preference, Object newValue) {
                        ...
                        SharedPreferences.Editor editor = AardvarkPedAnalysis.mSharedPreferences.edit();
                        editor.putBoolean(AardvarkPedWidgetService.PREFKEY_ShowMetric_BOOLEAN, SettingsFragment.mShowMetric);
                        editor.commit();
            ...
            if (mStrideLength != null ) {
                etpref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                    ...
                    public boolean onPreferenceChange(Preference preference, Object newValue) {
                        ...
                        SharedPreferences.Editor editor = AardvarkPedAnalysis.mSharedPreferences.edit();
                        editor.putFloat(AardvarkPedWidgetService.PREFKEY_StrideLength_FLOAT, (float) SettingsFragment.mStrideLengthInMeters);
                        editor.commit();
            ...
            if ( mPurgeTimePref != null ) {
                purge_time_pref.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                    ...
                    public boolean onPreferenceChange(Preference preference, Object newValue) {
                        ...
                        SharedPreferences.Editor editor = AardvarkPedAnalysis.mSharedPreferences.edit();
                        editor.putInt(AardvarkPedWidgetService.PREFKEY_PurgeDays_INT, SettingsFragment.mStepRetentionTime_Days);
                        editor.commit();
            ...
            if (archive != null) {
                archive.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                    ...
                    public boolean onPreferenceChange(Preference preference, Object newValue) {
                        ...
                        SharedPreferences.Editor editor = AardvarkPedAnalysis.mSharedPreferences.edit();
                        editor.putBoolean(AardvarkPedWidgetService.PREFKEY_Archive_BOOLEAN, SettingsFragment.mArchiveSteps);
                        editor.commit();
